				...
				switch ( $block ) {
				    case 'product-activation':
                        ...
                        <div class="fc-divider fcdoc-brow">
	                       	...
	                       	<div class="fc-10">For our each product we have set up demo pages where you can see the plugin in working mode.<br><br><strong><a href="'.$this->demoURL.'" target="_blank" class="fc-btn fc-btn-default get_started_link">Live Demos</a></strong>
	                         </div>
                        </div>';
