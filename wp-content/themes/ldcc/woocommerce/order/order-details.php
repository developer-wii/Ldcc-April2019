...
?>
<div class="row">
<div class="small-12 medium-6 large-6 columns view-order-left-column">
       ...
       ?>
        ...
        <ul class="order_details">
            <li class="oc-collect-date">
                    Collection Date:
                    <strong><?php echo $newCollectionFormat; ?></strong>
            </li>
            ...
            <li class="oc-drop-date">
                    Dropoff Date:
                    <strong><?php echo $newDropoffFormat; ?></strong>
            </li>
...
<div class="small-12 medium-6 large-6 columns view-order-right-column">
